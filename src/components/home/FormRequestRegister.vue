<template>
    <div class="container">
        <q-form id="signupForm" @submit="onSubmit" @reset="onReset" class="form q-pa-lg text-center">
            ...
            <q-input class="inputBox col-12" v-model="lastname" label="Apellido paterno">
                <template v-slot:prepend>
                    <div class="icon-container">
            ...
            <q-input class="inputBox col-12" v-model="lastname2" label="Apellido materno">
                <template v-slot:prepend>
                    <div class="icon-container">
                        <q-icon class="q-px-sm iconForm" name="fas fa-user-friends"></q-icon>
                    </div>
                </template>
            </q-input>

            <q-select class="inputBox col-12" label="Mi ubicación" v-model="location" :options="locationOptions"
                use-input @filter="filterDestinations">
                <template v-slot:prepend>
                    <div class="icon-container">
            ...
            <q-input class="inputBox col-12" v-model="phone" label="Número de teléfono">
                <template v-slot:prepend>
                    <div class="icon-container">
